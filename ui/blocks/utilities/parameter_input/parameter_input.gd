...
var _option_theme := _make_option_theme()
...
func _switch_input(node: Node):
	...
	if option_data:
		_option_input.add_theme_stylebox_override("focus", _option_theme)
		_option_input.add_theme_stylebox_override("hover", _option_theme)
		_option_input.add_theme_stylebox_override("pressed", _option_theme)
		_option_input.add_theme_stylebox_override("normal", _option_theme)
...
func _make_option_theme() -> StyleBoxFlat:
	var style := StyleBoxFlat.new()
	style.bg_color = Color(1, 1, 1, 0.501961)
